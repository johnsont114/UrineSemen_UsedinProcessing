...
if __name__ == "__main__":
    ...
    """
    df1 = pd.read_csv('Imputed_SemUr_CleanFna_LowFreq1000p.csv')
    df1 = df1.set_index('Alignment')
    
    df2 = pd.read_csv('Index_Semen+Urine_Reruns_noblankorQC.csv')
    ...
    ebat.to_csv('BatchCorr_SemUr_CleanFnaBaCShC_G1000.csv')
